...
The serial number in model 1 has been replaced with ``8.6TL00000000``. A real
one identifies someone's hardware, and this package is published; nothing in
the library depends on its value.
"""
...
# The same inverter after dark, in the SLEEPING state. Captured so tests can
# cover what this firmware does at night: it stays on Modbus and answers
# normally, but parks the registers it is no longer measuring at zero rather
# than at the "not implemented" sentinel. See docs/quirks.md.
BLUEPLANET_86TL3_ASLEEP: dict[int, int] = {
    40000: 0x5375,
    40001: 0x6E53,
    40002: 0x0001,
    40003: 0x0042,
